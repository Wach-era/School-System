...
<body>
<div class="container">
    <h2>Record Conduct for ID: ${param.staffId}</h2>

   <form action="${pageContext.request.contextPath}/staff-conduct/${conduct != null ? 'update' : 'insert'}" method="post">
            ...
            <tbody>
                <c:forEach var="conduct" items="${listConduct}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/staff-conduct/edit?id=${conduct.conductId}&staffId=${param.staffId}" class="btn btn-primary">Edit</a>
                            <a href="${pageContext.request.contextPath}/staff-conduct/delete?id=${conduct.conductId}&staffId=${param.staffId}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
