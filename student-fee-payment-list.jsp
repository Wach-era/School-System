...
<a href="${pageContext.request.contextPath}/finance.jsp" class="btn mb-3">Go Back</a>
    <a href="${pageContext.request.contextPath}/students/new" class="btn mb-3">Add New Student</a>
        ...
        <tbody>
            <c:forEach var="student" items="${listStudents}">
                <tr>
                    ...
                    <td>${student.totalFeesDue}</td>
                    <td>
                        <form action="${pageContext.request.contextPath}/student-fee-payment/new" method="get">
                            <input type="hidden" name="studentId" value="${student.studentId}">
                            <button type="submit" class="btn btn-success">Handle Payment</button>
                        </form>
                    </td>
                </tr>
            </c:forEach>
