...
<body>
    ...
    <h1>Report for ID: ${param.studentId}</h1>
        <form action="${pageContext.request.contextPath}/reportservlet/create" method="post" onsubmit="return validateForm()">
            ...
            <a href="${pageContext.request.contextPath}/students/list" class="btn btn-secondary mb-3">Go Back</a>
                        <a href="${pageContext.request.contextPath}/reportservlet/generate?studentId=${param.studentId}" class="btn btn-secondary mb-3">Refresh</a>
