...
<body>
    ...
    <h1>Report for ID: ${param.nationalId}</h1>
    <a href="${pageContext.request.contextPath}/teachers/list" class="btn btn-secondary mb-3">Go Back</a>
                        <a href="${pageContext.request.contextPath}/teacherreportservlet/generate?nationalId=${param.nationalId}" class="btn btn-secondary mb-3">Refresh</a>
            
        <form action="${pageContext.request.contextPath}/teacherreportservlet/create" method="post" onsubmit="return validateForm()">
            ...
            <div class="form-group checkbox-group">
                ...
                <input type="checkbox" id="clubs" name="categories" value="clubs">
   ...
   <div class="table-container">
            ...
            <c:if test="${not empty teacher}">
                ...
                <p><strong>Teacher National ID:</strong> ${teacher.nationalId}</p>
                <p><strong>Date of Birth:</strong> ${teacher.dateOfBirth}</p>
                <p><strong>Hire Date:</strong> ${teacher.dateOfHire}</p>
            </c:if>
