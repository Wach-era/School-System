...
<body>
<div class="container">
    <h2>Record Attendance for ID: ${param.nationalId}</h2>

    <form action="${pageContext.request.contextPath}/teacher-attendance/${attendance != null ? 'update' : 'insert'}" method="post">
    <input type="hidden" name="attendanceId" value="${attendance != null ? attendance.attendanceId : ''}" />
    <input type="hidden" name="nationalId" value="${param.nationalId}" />
    ...
    <button type="submit" class="btn btn-primary">${attendance != null ? 'Update Attendance' : 'Record Attendance'}</button>
                ...
                <a href="${pageContext.request.contextPath}/teachers/list" class="btn btn-primary">Go Back</a>
            ...
            <tbody>
                <c:forEach var="attendance" items="${attendanceList}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/teacher-attendance/edit?attendanceId=${attendance.attendanceId}&nationalId=${param.nationalId}" class="btn btn-primary">Edit</a>
                            <a href="${pageContext.request.contextPath}/teacher-attendance/delete?attendanceId=${attendance.attendanceId}&nationalId=${param.nationalId}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
