...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/teacher-subject/assign" method="post">
        <div class="form-group">
            <label for="nationalId">Teacher National ID:</label>
            ...
            <tbody>
                <c:forEach var="subject" items="${listSubjects}">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="subjects" value="${subject.subjectName}">
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
