...
<head>
    <meta charset="UTF-8">
    <title>Handle Staff Payroll</title>
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/staff-payroll/${payroll != null ? 'update' : 'insert'}" method="post">
        <input type="hidden" name="payrollId" value="${payroll != null ? payroll.payrollId : ''}" />
        <input type="hidden" name="staffId" value="${payroll != null ? payroll.staffId : staff.staffId}" />
        
        <div class="form-group">
            <label for="account_number">Account Number</label>
            <input type="text" id="acoount_number" name="account_number" class="form-control" value="${payroll != null ? payroll.account_number : none}" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a href="${pageContext.request.contextPath}/staff-payroll/list" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
            ...
            <tbody>
                <c:forEach var="payment" items="${listPayments}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/staff-payroll/edit?payrollId=${payment.payrollId}" class="btn btn-primary">Edit</a>
                            <a href="${pageContext.request.contextPath}/staff-payroll/delete?payrollId=${payment.payrollId}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
