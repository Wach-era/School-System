...
<body>
<div class="container">
    <h2>Record Conduct for ID: ${param.nationalId}</h2>

   <form action="${pageContext.request.contextPath}/teacher-conduct/${conduct != null ? 'update' : 'insert'}" method="post">
            ...
            <tbody>
                <c:forEach var="conduct" items="${listConduct}">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/teacher-conduct/edit?id=${conduct.conductId}&nationalId=${param.nationalId}" class="btn btn-primary">Edit</a>
                            <a href="${pageContext.request.contextPath}/teacher-conduct/delete?id=${conduct.conductId}&nationalId=${param.nationalId}" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
